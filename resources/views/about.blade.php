    ...
    <section class="py-16 bg-gradient-to-r from-blue-600 to-blue-700 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center text-white relative">
                ...
                <p class="text-4xl md:text-5xl font-bold mb-4 text-white">About San Isidro College</p>
                    ...
                    <div class="bg-white rounded-2xl p-8 shadow-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                            <div class="text-center p-4 bg-white rounded-lg shadow">
                                <div class="text-3xl font-bold text-blue-600 mb-2">1949</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-xl">
                    <div class="text-center mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-black mb-4">Our Vision</h3>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-black mb-2">Excellence</h3>
                        <p class="text-black text-sm">Pursuing the highest standards in all endeavors</p>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-black mb-2">Integrity</h3>
                        <p class="text-black text-sm">Honest, ethical, and principled in all actions</p>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-black mb-2">Service</h3>
                        <p class="text-black text-sm">Committed to serving the community</p>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-black mb-2">Innovation</h3>
                        <p class="text-black text-sm">Embracing creativity and technological advancement</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                    <div class="text-center">
                        <div class="w-32 h-32 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4 border-2 border-gray-200">
                            <svg class="w-12 h-12 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                            </svg>
                        </div>
                        <h3 class="text-xl font-semibold text-black mb-2">FR. VIRGILIO H. DELFIN, CPA, DBM</h3>
                        <p class="text-black mb-4">School President</p>
                        <p class="text-black text-sm">Leading the institution with 20+ years of experience in education and administration.</p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                    <div class="text-center">
                        ...
                        <h3 class="text-xl font-semibold text-black mb-2">Dr. Sol G. Simbulan</h3>
                        <p class="text-black mb-4">Vice President for Academic Affairs</p>
                        <p class="text-black text-sm">Championing academic excellence and curriculum development.</p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                    <div class="text-center">
                        ...
                        <h3 class="text-xl font-semibold text-black mb-2">Elven James S. Acal, MA, REB</h3>
                        <p class="text-black mb-4">Dean of Student Affairs</p>
                        <p class="text-black text-sm">Dedicated to student welfare and holistic development.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg">
                <h3 class="text-xl sm:text-2xl font-semibold text-black mb-4 sm:mb-6 text-center">Organizational Structure</h3>
                <div class="flex flex-col items-center space-y-3 sm:space-y-4">
                    <!-- Level 1 -->
                    <div class="w-full max-w-xs sm:max-w-sm md:w-64 p-3 sm:p-4 bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg text-white text-center text-sm sm:text-base font-semibold">
                        School President
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3 mt-2 sm:mt-4 w-full max-w-4xl">
                        <div class="w-full p-2 sm:p-3 bg-blue-100 rounded-lg text-black text-center text-xs sm:text-sm font-medium">
                            Deans
                        </div>
                        <div class="w-full p-2 sm:p-3 bg-green-100 rounded-lg text-black text-center text-xs sm:text-sm font-medium">
                            Directors
                        </div>
                        <div class="w-full p-2 sm:p-3 bg-purple-100 rounded-lg text-black text-center text-xs sm:text-sm font-medium">
                            Coordinators
                        </div>
                        <div class="w-full p-2 sm:p-3 bg-orange-100 rounded-lg text-black text-center text-xs sm:text-sm font-medium">
                            Faculty
                        </div>
                        <div class="w-full p-2 sm:p-3 bg-red-100 rounded-lg text-black text-center text-xs sm:text-sm font-medium">
                            Staff
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg">
                    <h3 class="text-2xl font-semibold text-black mb-6">Campus Location</h3>
                    <div class="aspect-w-16 aspect-h-9 bg-gray-100 rounded-lg overflow-hidden">
                        <div class="flex items-center justify-center h-64 bg-gray-50">
                            <!-- Placeholder for Google Maps or map image -->
                            <div class="text-center p-8">
                                <svg class="w-24 h-24 text-black mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                </svg>
                                <p class="text-black font-medium">Main Campus Location</p>
                                <p class="text-black text-sm">123 Education Street, San Isidro City</p>
                            </div>
                        </div>
                    </div>
                    <div class="mt-6">
                        <div class="bg-white rounded-lg p-4 shadow">
                            <h4 class="font-semibold text-black mb-2">Campus Buildings:</h4>
                ...
                <!-- Virtual Tour -->
                <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg">
                    <h3 class="text-2xl font-semibold text-black mb-6">Virtual Campus Tour</h3>
                    <div class="aspect-w-16 aspect-h-9 bg-gray-100 rounded-lg overflow-hidden mb-6">
                        <div class="flex items-center justify-center h-64">
                            ...
                            <div class="text-center p-8">
                                ...
                                <p class="text-black font-medium">Interactive 360° Campus Tour</p>
                                <p class="text-black text-sm mt-2">Experience our campus from anywhere</p>
                            </div>
                        </div>
                    </div>
                    
                    <div class="space-y-4">
                        <button class="w-full hover:bg-gray-200 text-black border-2 border-gray-300 font-semibold py-3 px-6 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button class="bg-white border border-gray-200 text-black font-medium py-3 px-4 rounded-lg hover:bg-gray-100 transition-colors duration-200 flex items-center justify-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
