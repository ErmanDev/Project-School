        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="bg-indigo-50 rounded-lg p-5 border border-indigo-200 hover:shadow-md transition-shadow">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex-1">
                                    <h3 class="font-semibold text-gray-900 mb-1">Student Handbook</h3>
                                    <p class="text-sm text-gray-600 mb-3">Complete guide to college policies and procedures</p>
                        ...
                        <div class="bg-indigo-50 rounded-lg p-5 border border-indigo-200 hover:shadow-md transition-shadow">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex-1">
                                    <h3 class="font-semibold text-gray-900 mb-1">Academic Calendar</h3>
                                    <p class="text-sm text-gray-600 mb-3">Important dates and deadlines for the academic year</p>
                                    <p class="text-xs text-gray-500">PDF • 423 KB</p>
                                </div>
                                <svg class="w-8 h-8 text-red-500 flex-shrink-0 ml-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clip-rule="evenodd"></path>
                                </svg>
                        ...
                        <div class="bg-indigo-50 rounded-lg p-5 border border-indigo-200 hover:shadow-md transition-shadow">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex-1">
                                    <h3 class="font-semibold text-gray-900 mb-1">Code of Conduct</h3>
                                    <p class="text-sm text-gray-600 mb-3">Student code of conduct and disciplinary policies</p>
                                    <p class="text-xs text-gray-500">PDF • 356 KB</p>
                                </div>
                                <svg class="w-8 h-8 text-red-500 flex-shrink-0 ml-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clip-rule="evenodd"></path>
                                </svg>
