    ...
    <section class="py-16 bg-gradient-to-r from-blue-600 to-blue-700 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center text-white relative">
                ...
                <p class="text-4xl md:text-5xl font-bold mb-4 text-white">Academic Personnel</p>
                <p class="text-xl text-blue-100">Meet Our Dedicated Faculty Members</p>
            </div>
        </div>
    </section>

    <!-- Academic Personnel Section -->
    <section class="py-16 bg-white dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Our Academic Personnel</h2>
                <div class="w-24 h-1 bg-blue-600 mx-auto mb-8"></div>
                <p class="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    Our faculty members are committed to providing quality education and fostering academic excellence. 
                    They bring years of experience, expertise, and dedication to their respective fields.
                </p>
            </div>

            @if($academicPersonnel->isEmpty())
                <div class="text-center py-12">
                    <svg class="w-24 h-24 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                    <p class="text-gray-600 dark:text-gray-300 text-lg">No academic personnel found at this time.</p>
                </div>
            @else
                <!-- Group by Department -->
                @foreach($allDepartments as $department)
                    @php
                        $departmentPersonnel = $academicPersonnel->filter(function($person) use ($department) {
